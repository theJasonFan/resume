...
\name{Jason  Fan}
\address{Tufts University $\mid$ the.jasonfan@gmail.com $\mid$ thejasonfan.github.io $\mid$ GitHub: thejasonfan}
...
\begin{document}
  ...
  \begin{rSection}{Projects}
    ...
    \item Collaborated with 2 other team members leading the implementation and improving of mathematical model that powered our solution.
    \end{rSubsection}
